 ...
 */
 !function (e, t) {
	...
	function b(e, n) {
		var r;
		void 0 === n && (n = []);
		var o = y(e), i = o === (null == (r = e.ownerDocument) ? void 0 : r.body), a = t(o), s = i ? [a].concat(a.visualViewport || [], h(o) ? o : []) : o, f = n.concat(s);
	...
	function O(e) {
		...
		return i && ('html' === p(i) || 'body' === p(i) && 'static' === d(i).position) ? n : i || function (e) {
			...
			if (-1 !== navigator.userAgent.indexOf('Trident') && r(e) && 'fixed' === d(e).position)
				return null;
			var n = g(e);
			for (o(n) && (n = n.host); r(n) && [
				...
				if ('none' !== i.transform || 'none' !== i.perspective || 'paint' === i.contain || -1 !== [
						'transform',
						'perspective'
					].indexOf(i.willChange) || t && 'filter' === i.willChange || t && i.filter && 'none' !== i.filter)
					return n;
				n = n.parentNode;
			}
			return null;
	...
	function te(e) {
		...
		if (l) {
			...
			if (B === t(r) && 'static' !== d(B = u(r)).position && 'absolute' === c && (H = 'scrollHeight', T = 'scrollWidth'), B = B, i === j || (i === A || i === D) && a === k)
				...
				var t = e.state, n = e.options, r = e.name, o = n.offset, i = void 0 === o ? [
						...
						return e[n] = function (e, t, n) {
							var r = C(e), o = [
									A,
									j
								].indexOf(r) >= 0 ? -1 : 1, i = 'function' == typeof n ? n(Object.assign({}, t, { placement: e })) : n, a = i[0], s = i[1];
	...
	var le = {
		...
		fn: function (e) {
			var t = e.state, n = e.options, r = e.name, o = n.mainAxis, s = void 0 === o || o, f = n.altAxis, c = void 0 !== f && f, p = n.boundary, u = n.rootBoundary, l = n.altBoundary, d = n.padding, h = n.tether, m = void 0 === h || h, g = n.tetherOffset, y = void 0 === g ? 0 : g, b = Y(t, {
					...
					padding: d,
					altBoundary: l
				}), x = C(t.placement), w = _(t.placement), L = !w, P = F(x), k = 'x' === P ? 'y' : 'x', W = t.modifiersData.popperOffsets, B = t.rects.reference, H = t.rects.popper, T = 'function' == typeof y ? y(Object.assign({}, t.rects, { placement: t.placement })) : y, R = 'number' == typeof T ? {
					mainAxis: T,
					altAxis: T
				} : Object.assign({
					mainAxis: 0,
	...
	var ve = {
			...
			requiresIfExists: ['preventOverflow'],
			fn: function (e) {
				var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, a = Y(t, { elementContext: 'reference' }), s = Y(t, { altBoundary: !0 }), f = he(a, r), c = he(s, o, i), p = me(f), u = me(c);
				t.modifiersData[n] = {
